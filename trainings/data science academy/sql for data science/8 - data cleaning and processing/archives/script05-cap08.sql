...
ALTER TABLE `dsa_module_eight`.`tb_vendas` 
...
UPDATE dsa_module_eight.tb_vendas 
SET comissao = 5
WHERE empID = 1;
...
SELECT empID, valor_venda, comissao, ROUND((valor_venda * comissao) / 100, 0) AS valor_comissao
...
CREATE TABLE dsa_module_eight.tb_acoes (dia INT, num_vendas INT, valor_acao DECIMAL(10,2));

INSERT INTO dsa_module_eight.tb_acoes VALUES 
(1, 32, 0.3),
(1, 4, 70),
(1, 44, 200),
(1, 9, 0.01),
...
SELECT * FROM dsa_module_eight.tb_acoes;
...
FROM dsa_module_eight.tb_acoes
GROUP BY dia;
