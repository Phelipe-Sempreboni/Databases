...
SELECT 
    ...
    ,IRRADIANDO
	,CONCAT(INV_NODES, '-' ,QUADRANTE) AS POSICAO_TUMOR
    ,CASE WHEN DEG_MALIG = 1 THEN 1 ELSE DEG_MALIG = 0 END AS DEG_MALIG_CAT_1
    ,CASE WHEN DEG_MALIG = 2 THEN 2 ELSE DEG_MALIG = 0 END AS DEG_MALIG_CAT_2
    ,CASE WHEN DEG_MALIG = 3 THEN 3 ELSE DEG_MALIG = 0 END AS DEG_MALIG_CAT_3
