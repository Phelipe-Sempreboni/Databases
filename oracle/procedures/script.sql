...
-- Query para listar as functions, packages, procedures, trigger, type e mais funções do banco de dados.
...
-- Script para executar uma procedure com mais eficácia.
-- Substitua os campos (SCHEMA e PROCEDURE).
SET ECHO ON
SET SERVEROUTPUT ON
BEGIN
